 ...
 * Description:
 */
class SphereRefractionPicassoTransform(private var center: PointF = PointF(0.5f, 0.5f),
                                       private var radius: Float = 0.25f,
                                       private var refractiveIndex: Float = 0.71f
): PicassoBaseTransform(GPUImageSphereRefractionFilter(center, radius, refractiveIndex))
{
