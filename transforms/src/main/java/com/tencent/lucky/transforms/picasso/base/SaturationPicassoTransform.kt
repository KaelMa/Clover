 ...
 * Description:
 */
class SaturationPicassoTransform(var saturation: Float = 1f):
    PicassoBaseTransform(GPUImageSaturationFilter(saturation))
{
    override fun key(): String {
        return super.key() + ".saturation=$saturation"
    }
}