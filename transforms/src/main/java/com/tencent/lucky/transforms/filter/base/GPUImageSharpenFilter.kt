 ...
 */
class GPUImageSharpenFilter(private var mSharpness: Float = 0.0f)
    : GPUImageFilter(
    ...
    override fun onInit() {
        super.onInit()
        mSharpnessLocation = GLES30.glGetUniformLocation(program, "sharpness")
        mImageWidthFactorLocation = GLES30.glGetUniformLocation(program, "imageWidthFactor")
        mImageHeightFactorLocation = GLES30.glGetUniformLocation(program, "imageHeightFactor")
