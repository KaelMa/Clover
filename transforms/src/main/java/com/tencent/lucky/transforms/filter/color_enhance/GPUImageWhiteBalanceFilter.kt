 ...
 */
class GPUImageWhiteBalanceFilter(
    private var mTemperature: Float = 5000.0f,
    private var mTint: Float = 0.0f
) : GPUImageFilter(
    ...
    override fun onInit() {
        super.onInit()
        mTemperatureLocation = GLES30.glGetUniformLocation(program, "temperature")
        mTintLocation = GLES30.glGetUniformLocation(program, "tint")
    ...
    fun setTemperature(temperature: Float) {
        ...
        setFloat(
            ...
            if (mTemperature < 5000) (0.0004 * (mTemperature - 5000.0)).toFloat() else (0.00006 * (mTemperature - 5000.0)).toFloat()
        )
    }
    ...
    companion object {
        const val WHITE_BALANCE_FRAGMENT_SHADER = "" +
